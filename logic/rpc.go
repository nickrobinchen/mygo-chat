...
// reply: authtoken
func (rpc *RpcLogic) Register(_ context.Context, args *proto.RegisterRequest, reply *proto.RegisterReply) (err error) {
	...
	*/
	...
	RedisSessClient.Expire(sessionId, 86400*time.Second) // One day
...
// authToken -> sessionName -> userData
